<template>
  ...
  >
    <div class="container mx-auto flex justify-center items-center">
      <a
        href="https://github.com/zhifanXU17"
        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg p-2.5 mr-1"
      >
        <svg
          class="w-5 h-5"
          aria-hidden="true"
      ...
      <a
        href="mailto:zhifanXu17@gmail.com"
        target="_blank"
        class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg p-2.5 mr-1"
      >
        <svg
